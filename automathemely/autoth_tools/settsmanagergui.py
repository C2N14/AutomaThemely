...
class App(Gtk.Application):
    ...
    def do_startup(self):
        ...
        self.system_themes = envspecific.get_installed_themes(self.settings_handler.get_setting('desktop_environment'))
        ...
        for obj in self.builder.get_objects():
            ...
            if '___object_' not in obj_id:
                ...
                #   These DO contain data
                    ...
                    val = self.settings_handler.get_setting(obj_path)
    ...
    def populate_themes_cboxt(self, cboxt):
        ...
        val = self.settings_handler.get_setting(cboxt_path)
        themes = []
    ...
    def on_any_change(self, emitter, *args):
        if self.listen_changes:
            ...
            if get_object_data(emitter) != self.settings_handler.get_setting(emitter_path):
    ...
    def on_save_settings(self, *args):
        if self.entries_error:
            ...
            for change_obj in self.changed:
                ...
                self.settings_handler.set_setting(change_path, get_object_data(change_obj))
